...
namespace BatDongSan.Controllers.QLSuatAn
{
    public class PhieuDangKySuatAnController : ApplicationController
    {
        ...
        public ActionResult Index(int? id, int? _page, string searchString, string maCuaHang, string tuNgay, string denNgay)
        {
            #region Role user
            ...
            try
            {
                ...
                string param = "?maCuaHang=" + maCuaHang + "&searchString=" + searchString + "&tuNgay=" + tuNgay + "&denNgay=" + denNgay;
                int? page = _page == 0 ? 1 : _page;
                int? pIndex = page;
                var lstCuaHangMonAn = context.sp_NS_DanhSachPhieuDangKySuatAn_Index(GetUser().manv, maCuaHang, fromDate, toDate, searchString).ToList();
        ...
        public ActionResult ViewIndex(int? id, int? _page, string searchString, string maCuaHang, string tuNgay, string denNgay)
        {
            #region Role user
            permission = GetPermission(MCV, BangPhanQuyen.QuyenXem);
            if (!permission.HasValue)
        ...
        public ActionResult Create()
        {
            ...
            var timeTo = new DateTime(DateTime.Now.Year,DateTime.Now.Month,DateTime.Now.Day,11,55,00);
            // Check 1330 
        ...
        public ActionResult LoadDanhSachPhanBo(int thang, int nam)
        {
            ...
            var nhanVien = qLSAContext.sp_SA_DangKySuatAn_CongChuanNhanVien_TVWindow(thang, nam).Where(d=>d.maNhanVien == GetUser().manv).FirstOrDefault();
