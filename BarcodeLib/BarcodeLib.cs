 ...
 * ***************************************************
 */
namespace BatDongSan.Models.BarcodeLib
{
    #region Enums
    ...
    {
        #region Variables
        private IBarcode ibarcode = new BatDongSan.Symbologies.Blank();
                ...
                default:
                    {
                        ...
                        switch (Alignment)
                        {
                            ...
                            case AlignmentPositions.CENTER: shiftAdjustment = 0;
                                break;
